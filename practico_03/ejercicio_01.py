...
def crear_tabla():
    ...
    cursor=db.cursor()
    sentencia='CREATE TABLE IF NOT EXISTS personas([idPersona] INTEGER PRIMARY KEY AUTOINCREMENT, [nombre] text(30), [fechaNacimiento] date, [dni] integer, [altura] integer)'
